...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <head>
      ...
      <meta name="Description" content="Econet is a privately held diversified telecommunications group with operations and investments in Africa, Europe, South America, North America and the East Asia Pacific Rim."/>
      <meta name="Keywords" content=""/>
      <link rel="stylesheet" href="{{asset('econetafrica.com/www.econetafrica.com/css/prettyPhoto.css')}}" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      <link rel="shortcut icon" type="image/x-icon" href="{{asset('econetafrica.com/www.econetafrica.com/images/favicon.png')}}">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <link href="{{asset('econetafrica.com/www.econetafrica.com/font-awesome-4.6.1/css/font-awesome.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('econetafrica.com/www.econetafrica.com/font-awesome-4.6.1/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css" />
      <link href="{{asset('econetafrica.com/www.econetafrica.com/css/style.css')}}" rel="stylesheet" type="text/css">
      <script src="{{asset('econetafrica.com/www.econetafrica.com/js/jquery-latest.min.js')}}"></script>
      ...
      <link href="{{asset('econetafrica.com/www.econetafrica.com/css/nav-style.css')}}" rel="stylesheet">
      <script>
         ...
         var mytime=10000;
         for(i=1;i<=100;i++){
         setTimeout(click2, mytime);
         mytime=mytime+10000;
         setTimeout(click3, mytime);
         mytime=mytime+10000;
         setTimeout(click4, mytime);
         mytime=mytime+10000;
         setTimeout(click1, mytime);
         mytime=mytime+10000;
         }
         });
      </script>
   ...
   <body>
      <header class="homeheader">
         <div class="header-area">
            <div class="lay-width clearfix">
               <div class="logo">
                  <a href="{{url('/')}}"><img class="hlogo" src="{{asset('econetafrica.com/www.econetafrica.com/images/logo1.png')}}" alt="Econet Wireless Logo" title="Econet Wireless"/>
      ...
      <div class="banner-area">
         <div class="banner-text">
            ...
            <h2>ECONET is a 30&nbsp;year-old entrepreneurial&nbsp;technology group, focused on digitally connecting customers across Sub Saharan Africa.</h2>
            <div class="clearfix banner-video gallery">
               <a title="Watch Video" class="pp-btn" href="#inline_demo" rel="prettyPhoto[inline]">Video</a>
               <div id="inline_demo" style="display:none; width:100%;">
                  <video class="vheight" controls="true" id="myVideo" loop="loop" width="100%">
                     <source src="images/video/ecgp.mp4" type="video/mp4" />
                  </video>
               </div>
            </div>
         ...
         <div class="container-area2">
            ...
            <div class="coporate3col">
               <div class="col_1">
                  ...
                  <h4><span>million</span></h4>
               </div>
               <div class="col_1">
                  <p>Terrestrial fibre Optic across Africa</p>
                  <h4>+</h4>
                  <h4 class="numscroller" data-delay="3" data-increment="500" data-max="60000" data-min="0" data-slno="1">60,000</h4>
                  <h4><span>miles</span></h4>
               </div>
               <div class="col_1 lastbd">
                  <p>Mobile money wallets connected</p>
                  <h4>+</h4>
                  <h4 class="numscroller" data-delay="3" data-increment="5" data-max="100" data-min="0" data-slno="1">100</h4>
                  <h4><span>million</span></h4>
               </div>
            ...
            <div class="coporate4col">
               ...
               <div class="text-center"><a class="btnnew" href="investors.html">See More</a></div>
            </div>
            <div class="clearfix"></div>
         </div>
      </div>
      <div class="container-area1 ourchairman">
         <div class="leftsection">
            <div class="txt1">
               <h2>Meet Our Chairman Strive Masiyiwa</h2>
               <p>Strive Masiyiwa is internationally recognised for his leadership contributions in a number of areas outside of business including his mentorship of millions of young entrepreneurs across Africa, who will create jobs for the next generation.</p>
               <p><a class="btnnew1" href="strive-masiyiwa.html">Learn more about our Chairman<br />
                  and Founder Strive Masiyiwa</a>
               </p>
            </div>
         </div>
      ...
      <div class="sustainability-area">
         <div class="container-area3">
            <h3>Sustainability & Doing Good</h3>
            <p>At Econet we are cognisant that to do well, we must tackle the challenges within the communities in which we do business.</p>
            <p><a class="btnnew2" href="econet-sustainability.html"><i class="fa fa-angle-right">&nbsp;</i> Learn more</a></p>
         </div>
      </div>
      <div class="digitally-area">
         <div class="container-area3">
            <h3>Be Part of Building Digitally Connected Future</h3>
            <p>At Econet we are always on the lookout for the world&prime;s best talent who can help us build outstanding businesses.</p>
            <p><a class="btnnew3" href="careers.html">Explore</a></p>
         </div>
      </div>
      <div class="recent-news_press-release-area">
         <div class="container-area2 recentnews">
            ...
            <div class="recentnewsbox ">
               ...
               <div class="newstxt">
                  ...
                  <p></p>
                  <p><a title="Global technology leader Epson has partnered with Liquid Intelligent Technologies in Kenya" href="https://www.econetafrica.com/news/global-technology-leader-epson-has-partnered-with-liquid-intelligent-technologies-in-kenya"> > Read more...</a></p>
               </div>
            </div>
            <div class="recentnewsbox ">
               ...
               <div class="newstxt">
                  ...
                  <p></p>
                  <p><a title="Econet Wireless Empowers Women-Owned Businesses" href="https://www.econetafrica.com/news/econet-wireless-empowers-women-owned-businesses"> > Read more...</a></p>
               </div>
            </div>
            <div class="recentnewsbox mright0">
               ...
               <div class="newstxt">
                  ...
                  <p></p>
                  <p><a title="Liquid Intelligent Technologies achieves Cisco Gold Certification, elevating the delivery of network services for South African customers" href="https://www.econetafrica.com/news/liquid-intelligent-technologies-achieves-cisco-gold-certification-elevating-the-delivery-of-network-services-for-south-african-customers"> > Read more...</a></p>
               </div>
            </div>
            <div class="clearfix h40"></div>
            <div class="text-center"><a class="allbt" href="latest-news.html">All news</a></div>
         </div>
      ...
      <div class="footer">
         <div class="lay-width clearfix">
            ...
            <div class="fright">
               <p>© Copyright {{date('y')}} - Econet Group - All rights reserved. <a href="cookies-policy.html" title="Cookie Policy">Cookie Policy</a><a href="privacy-policy.html" title="Privacy Policy">Privacy Policy</a><a href="sitemap.html" title="Site Map">Site Map</a></p>
            </div>
         </div>
      </div>
